import { ValidationError as n } from "./Errors-CBeo1Lsn.mjs";
function s(t, i) {
  const a = [];
  if (!t.content && !t.title && a.push("Document must have at least 'content' or 'title' field"), t.metadata !== void 0 && (typeof t.metadata != "object" || t.metadata === null ? a.push("metadata must be a plain object (got " + typeof t.metadata + ")") : Array.isArray(t.metadata) && a.push("metadata must be a plain object, not an array"), t.metadata && !Array.isArray(t.metadata) && t.metadata.collection !== void 0 && a.push(
...
//# sourceMappingURL=Validation-E21ecA_U.mjs.map
