...
class L {
  ...
  call(e, t) {
    return new Promise((r, s) => {
      if (this.pendingCalls.size >= this.config.maxConcurrentOperations) {
        this.log("error", `Rate limit exceeded for ${e}: ${this.pendingCalls.size}/${this.config.maxConcurrentOperations}`), s(new d(
      ...
      const i = this.generateCallId(), n = Date.now(), a = setTimeout(() => {
        this.log("error", `Operation timeout for ${e} after ${this.config.operationTimeout}ms`), this.pendingCalls.delete(i), this.performanceMetrics.timeouts++, s(new d(
      ...
      try {
        ...
        this.log("error", `Failed to send RPC message for ${e}:`, p), this.pendingCalls.delete(i), clearTimeout(a), s(new d(
  ...
  async batchInsertDocuments(e) {
    return this.call("batchInsertDocuments", e);
  }
  // Search operations
  ...
  async enhanceQuery(e) {
    return this.call("enhanceQuery", e);
  }
  async summarizeResults(e) {
    return this.call("summarizeResults", e);
  }
  async searchWithLLM(e) {
    return this.call("searchWithLLM", e);
  }
  async callLLM(e) {
    return this.call("callLLM", e);
  }
...
class c extends Error {
  constructor(e, t = "EMBEDDING_ERROR", r = "unknown", s, i) {
    super(e), this.name = "EmbeddingError", this.code = t, this.category = r, this.context = s, this.recoveryInfo = i, this.timestamp = /* @__PURE__ */ new Date(), Object.setPrototypeOf(this, c.prototype);
  }
  /**
...
class l extends c {
  constructor(e, t, r = "PROVIDER_ERROR", s, i) {
    ...
    ), this.name = "ProviderError", this.providerName = t, this.modelVersion = s, Object.setPrototypeOf(this, l.prototype);
  }
}
class v extends l {
  constructor(e, t, r, s) {
...
class T extends l {
  constructor(e, t, r, s, i) {
    ...
    ), this.name = "ModelLoadError", this.modelName = r, this.modelSize = s, Object.setPrototypeOf(this, T.prototype);
  }
}
class u extends c {
  constructor(e, t, r, s, i) {
    const n = `NETWORK_${t.toUpperCase()}_ERROR`, a = u.getRetryDelay(r, t);
    super(
      e,
      n,
      "network",
    ...
    ), this.name = "NetworkError", this.statusCode = r, this.url = s, this.networkType = t, Object.setPrototypeOf(this, u.prototype);
  }
  /**
...
class m extends c {
  constructor(e, t, r, s, i) {
    ...
    ), this.name = "ConfigurationError", this.parameterName = t, this.expectedValue = r, this.actualValue = s, Object.setPrototypeOf(this, m.prototype);
  }
}
class M extends c {
  constructor(e, t, r, s) {
    ...
    ), this.name = "ValidationError", this.fieldName = t, this.validationRule = r, Object.setPrototypeOf(this, M.prototype);
  }
}
class y extends c {
  constructor(e, t, r, s, i, n) {
    ...
    super(
      ...
      { ...n, quotaType: t, currentValue: r, maxValue: s, resetTime: i },
      {
        ...
        suggestedActions: y.getSuggestedActions(t, i)
      }
    ), this.name = "QuotaExceededError", this.quotaType = t, this.currentValue = r, this.maxValue = s, this.resetTime = i, Object.setPrototypeOf(this, y.prototype);
  }
...
class C extends c {
  constructor(e, t, r, s) {
    ...
    ), this.name = "CacheError", this.cacheOperation = t, this.cacheKey = r, Object.setPrototypeOf(this, C.prototype);
  }
}
class E extends c {
  constructor(e, t, r, s) {
    ...
    ), this.name = "WorkerError", this.workerId = r, this.workerOperation = t, Object.setPrototypeOf(this, E.prototype);
  }
}
class S {
...
class w extends S {
  ...
  async initialize(e) {
    ...
    this.config = {
      ...
      timeout: e.timeout || w.DEFAULT_CONFIG.timeout,
      maxRetries: e.maxRetries || w.DEFAULT_CONFIG.maxRetries,
      enableRateLimit: e.providerOptions?.enableRateLimit ?? w.DEFAULT_CONFIG.enableRateLimit,
      requestsPerMinute: e.providerOptions?.requestsPerMinute || w.DEFAULT_CONFIG.requestsPerMinute,
   ...
   */
  shouldRetry(e) {
    return e instanceof g || e instanceof c && e.category === "configuration" ? !1 : e instanceof u ? e.recoveryInfo?.canRetry ?? !1 : e instanceof y || e instanceof R;
  }
  /**
  ...
  wrapError(e) {
    ...
    ) : e.message.includes("429") || e.message.includes("rate limit") ? new y(
...
class I extends w {
  ...
  async executeEmbeddingRequest(e) {
    ...
    try {
      ...
      throw n instanceof Error && n.name === "AbortError" ? new u(
  ...
  createErrorFromResponse(e, t) {
    ...
    switch (e) {
      ...
      case 429:
        return r.includes("quota") || r.includes("billing") ? new y(
...
function B(o, e = "text-embedding-3-small") {
  return new I(o, e);
}
function O(o, e) {
  return o in f ? f[o].supportedDimensions.includes(e) : !1;
}
function x(o) {
...
class D extends S {
  ...
  async generateEmbedding(e) {
    ...
    try {
      ...
      const s = Date.now() - t;
      throw this.updateMetrics(s, 1, !0), r instanceof Error ? r : new l(
  ...
  async generateBatch(e) {
    ...
    try {
      ...
      const s = Date.now() - t;
      throw this.updateMetrics(s, e.length, !0), r instanceof Error ? r : new l(
  ...
  handleWorkerError(e) {
    for (const [t, r] of this.pendingRequests)
      r.timeout && clearTimeout(r.timeout), r.reject(new E(
...
class $ {
  ...
  async getAvailableModels() {
    const e = [];
    return b() && e.push(k()), e.push(...I.getAvailableModels()), e;
  }
  /**
  ...
  getProviderRecommendations(e) {
    ...
    if ((n === "local" || n === "any") && b() && r === 384 && t.push({
      ...
      const a = x({ dimensions: r, budget: s, performance: i });
      t.push({
        provider: "openai",
        model: a.model,
  ...
  validateOpenAIConfig(e, t, r, s) {
    ...
    O(i, e.dimensions) || (t.push(`Model ${i} does not support ${e.dimensions} dimensions`), s.push("Check supported dimensions for the selected model")), e.batchSize && e.batchSize > 100 && (r.push("Large batch sizes may be inefficient for OpenAI API"), s.push("Consider using batch size of 50 or less"));
  }
  /**
...
const A = new $();
async function V(o) {
  return A.createProvider(o);
}
function K(o) {
  return A.validateConfiguration(o);
}
function G(o) {
  return A.checkProviderSupport(o);
}
function H(o) {
  return A.getProviderRecommendations(o);
}
function Q() {
...
//# sourceMappingURL=ProviderFactory-3B-jCMm2.mjs.map
