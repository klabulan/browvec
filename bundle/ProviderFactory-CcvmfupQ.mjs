...
class E extends A {
  ...
  async executeEmbeddingRequest(e) {
    ...
    try {
      ...
      throw n instanceof Error && n.name === "AbortError" ? new g(
...
class z extends $ {
  ...
  async _initialize(e) {
    try {
      ...
      throw this._isReady = !1, t instanceof Error ? new b(
...
class c {
   ...
   */
  static hashText(e, t = {}) {
    const r = t.algorithm === "simple" ? "simple" : "djb2";
    return {
      hash: c.simpleHash(e),
      algorithm: r,
      timestamp: /* @__PURE__ */ new Date()
...
class Z {
  ...
  static createDefaultCollectionConfig(e, t) {
    return {
      provider: e,
      dimensions: t,
      batchSize: M.DEFAULT_BATCH_SIZES[e],
      cacheEnabled: !0,
      timeout: e === "transformers" ? M.DEFAULT_TIMEOUTS.local : M.DEFAULT_TIMEOUTS.api,
      autoGenerate: !1,
      textPreprocessing: {
        maxLength: M.MAX_TEXT_LENGTHS[e],
        stripHtml: !0,
        stripMarkdown: !0,
...
class q {
  ...
  async createProvider(e) {
    try {
      ...
      throw t instanceof Error && t.name.includes("Error") ? t : new b(
  ...
  async getAvailableModels() {
    const e = [];
    return R() && e.push(O()), e.push(...E.getAvailableModels()), e;
  }
  /**
...
//# sourceMappingURL=ProviderFactory-CcvmfupQ.mjs.map
