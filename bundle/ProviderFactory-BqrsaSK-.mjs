...
class L {
  ...
  call(e, t) {
    return new Promise((r, i) => {
      ...
      const s = this.generateCallId(), n = Date.now(), a = setTimeout(() => {
      ...
      try {
        ...
        this.log("error", `Failed to send RPC message for ${e}:`, p), this.pendingCalls.delete(s), clearTimeout(a), i(new d(
...
class T extends l {
  constructor(e, t, r, i, s) {
    super(
      ...
      "MODEL_LOAD_ERROR",
      void 0,
      { ...s, modelName: r, modelSize: i }
    ), this.name = "ModelLoadError", this.modelName = r, this.modelSize = i, Object.setPrototypeOf(this, T.prototype);
  }
}
class u extends c {
  constructor(e, t, r, i, s) {
...
class y extends c {
  constructor(e, t, r, i, s, n) {
    const a = s ? s.getTime() - Date.now() : 36e5;
    super(
      e,
      "QUOTA_EXCEEDED",
      "quota",
      { ...n, quotaType: t, currentValue: r, maxValue: i, resetTime: s },
      {
        ...
        suggestedActions: y.getSuggestedActions(t, s)
      }
    ), this.name = "QuotaExceededError", this.quotaType = t, this.currentValue = r, this.maxValue = i, this.resetTime = s, Object.setPrototypeOf(this, y.prototype);
  }
...
class I extends c {
  constructor(e, t, r, i) {
    ...
    ), this.name = "WorkerError", this.workerId = r, this.workerOperation = t, Object.setPrototypeOf(this, I.prototype);
  }
}
class S {
    ...
    for (let s = 1; s <= i; s++)
      try {
        ...
        if (r = n, s < i && this.shouldRetry(n)) {
          const a = this.calculateRetryDelay(s, n);
          await this.sleep(a);
          continue;
        }
...
class E extends w {
  ...
  validateConfig(e) {
    ...
    if (n in f) {
      const a = f[n];
      a.supportedDimensions.includes(this.dimensions) || (r.push(`Model ${n} does not support ${this.dimensions} dimensions`), s.push(`Use one of: ${a.supportedDimensions.join(", ")}`));
    }
...
class D extends S {
  ...
  async generateBatch(e) {
    ...
    try {
      ...
      for (let n = 0; n < e.length; n += i) {
        const a = e.slice(n, n + i), h = await this.processBatchChunk(a);
        r.push(...h);
      }
      const s = Date.now() - t;
  ...
  async sendMessage(e, t, r) {
    if (!this.worker)
      throw new I("Web Worker не создан", e);
  ...
  handleWorkerError(e) {
    for (const [t, r] of this.pendingRequests)
      r.timeout && clearTimeout(r.timeout), r.reject(new I(
...
class $ {
  ...
  async getAvailableModels() {
    const e = [];
    return b() && e.push(k()), e.push(...E.getAvailableModels()), e;
  }
  /**
  ...
  getProviderRecommendations(e) {
    ...
    if ((n === "local" || n === "any") && b() && r === 384 && t.push({
      ...
      const a = x({ dimensions: r, budget: i, performance: s });
      t.push({
        provider: "openai",
        model: a.model,
  ...
  validateOpenAIConfig(e, t, r, i) {
    ...
    O(s, e.dimensions) || (t.push(`Model ${s} does not support ${e.dimensions} dimensions`), i.push("Check supported dimensions for the selected model")), e.batchSize && e.batchSize > 100 && (r.push("Large batch sizes may be inefficient for OpenAI API"), i.push("Consider using batch size of 50 or less"));
  }
  /**
...
//# sourceMappingURL=ProviderFactory-BqrsaSK-.mjs.map
